...
class MainTestCase(unittest.TestCase):
    ...
    def test_imagen_no_clara(self):
        # Prueba el manejo de errores cuando se recibe una imagen poco clara
        imagen_path = '11838.jpg'  # Cambia la ruta a una imagen no clara
